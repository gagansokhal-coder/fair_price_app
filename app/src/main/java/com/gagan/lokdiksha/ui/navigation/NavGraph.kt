package com.gagan.lokdiksha.ui.navigation
...
import com.gagan.lokdiksha.ui.screens.auth.*
import com.gagan.lokdiksha.ui.screens.citizen.*
import com.gagan.lokdiksha.ui.screens.admin.*
import com.gagan.lokdiksha.ui.screens.common.LegalDocumentScreen
import com.gagan.lokdiksha.ui.theme.ENTER_DURATION
import com.gagan.lokdiksha.ui.theme.EXIT_DURATION
    ...
    NavHost(
        ...
        composable(Screen.RoleSelection.route) {
            RoleSelectionScreen(
                ...
                onTermsClick = { navController.navigate(Screen.LegalDocument.createRoute("terms")) },
                onPrivacyClick = { navController.navigate(Screen.LegalDocument.createRoute("privacy")) },
                onAboutClick = { navController.navigate(Screen.LegalDocument.createRoute("about")) }
            )
        }
        ...
        composable(
            ...
            val documentType = backStackEntry.arguments?.getString("documentType") ?: "terms"
            LegalDocumentScreen(
